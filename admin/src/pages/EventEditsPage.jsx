...
import { usePendingEventEdits, useApproveEventEdit, useRejectEventEdit } from "../api/queries.js";
...
export default function EventEditsPage() {
  ...
  return (
    <div>
      ...
      {data && <DataTable data={data} columns={columns} getRowId={(row) => row.rowId} emptyMessage="No pending event edits." />}
    </div>
  );
}
