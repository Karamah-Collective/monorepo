...
import { useAdminEvents, useApproveEvent, useRejectEvent } from "../api/queries.js";
...
export default function EventsPage() {
  ...
  return (
    <div>
      ...
      {data && <DataTable data={data} columns={columns} getRowId={(row) => String(row.eventId)} emptyMessage="No events." />}
    </div>
  );
}
