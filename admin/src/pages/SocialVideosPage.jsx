    ...
    () => [
      ...
      columnHelper.accessor("url", {
        ...
        cell: (info) => {
          ...
          if (!url) return "—";
          return (
            <a href={url} target="_blank" rel="noopener noreferrer" className="pp-btn-text">
              Open
            </a>
          );
        },
  ...
  return (
    <div className="pp-page">
      ...
      <p className="pp-page-lead">
        Metadata-only clips for the Anar Discover feed. Tapping a tile opens TikTok, Instagram, or YouTube — nothing is hosted here.
      </p>
      ...
      <form className="pp-panel pp-social-form" onSubmit={onSubmit}>
        ...
        <div className="pp-social-grid">
          <div className="pp-field">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                const match = (places || []).find(
                  (p) => p.id === value || `${p.name} (${p.id})` === value || p.name === value
                );
            ...
            {form.placeId ? (
              <span className="pp-field-hint">Linked place id: {form.placeId}</span>
            ) : (
              <span className="pp-field-hint">Pick a published place from the list</span>
            )}
          </div>
        ...
        <div className="pp-social-form-actions">
          <button type="submit" className="pp-btn pp-btn-primary pp-btn-inline" disabled={upsertVideo.isPending}>
