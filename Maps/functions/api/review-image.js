...
import { allowedOrigin, json, sha256, truncate } from "../_shared.js";
...
async function _identityHash(token) {
...
export async function onRequestPost({ request, env }) {
  ...
  const emailHash = await _identityHash(token);
