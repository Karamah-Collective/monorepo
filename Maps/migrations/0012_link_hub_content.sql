...
ALTER TABLE link_hub_settings ADD COLUMN page_kicker TEXT NOT NULL DEFAULT '';
ALTER TABLE link_hub_settings ADD COLUMN links_kicker TEXT NOT NULL DEFAULT '';
ALTER TABLE link_hub_settings ADD COLUMN links_heading TEXT NOT NULL DEFAULT '';
ALTER TABLE link_hub_settings ADD COLUMN links_description TEXT NOT NULL DEFAULT '';
ALTER TABLE link_hub_settings ADD COLUMN count_suffix TEXT NOT NULL DEFAULT '';
...
ALTER TABLE link_hub_settings ADD COLUMN footer_link_label TEXT NOT NULL DEFAULT '';
