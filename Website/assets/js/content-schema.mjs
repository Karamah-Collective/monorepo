...
export const WEBSITE_FIELDS = {
  ...
  organizationName: text("Registered name", "Organization", "[data-site-organization-name]", 160, "Karamah Collective ry"),
  organizationNumber: text("FO number", "Organization", "[data-site-organization-number]", 80, "3649490-3"),
  organizationAddress: text("Registered address", "Organization", "[data-site-organization-address]", 240, "Kuurinkallio 11 D 22, 02750 Espoo"),
